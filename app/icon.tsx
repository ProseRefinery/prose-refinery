            ...
            >
                <div
                    style={{
                        ...
                        alignItems: 'center',
                        justifyContent: 'center',
                        borderRadius: '110px', // ~21% Rounding (Simulating CSS)
                    }}
                >
                    {/* Full Color Original Vector Icon */}
                    <svg
                        width="320"
                        height="320"
                    ...
                    >
                        ...
                        <path fill="none" stroke="#9384BE" strokeWidth="1.31" d="M409.06 578.58l-107.29 -98.01 -1.43 -169.44 51.64 0c19.58,0 38.18,-4.31 54.85,-12.02l2.23 279.47z" />
                        ...
                        <polygon fill="#017F5F" points="231.44,194.95 231.44,192.43 231.38,132.54 231.36,104.66 231.3,24.09 231.3,20.76 231.89,104.66 232.23,153.85 232.49,192.43 232.51,194.86 " />
                        {/* Main P Body */}
