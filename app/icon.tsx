        ...
        (
            <div
                style={{
                    ...
                    background: 'transparent', // Transparent ROOT to avoid square black corners behind the curve
                }}
            >
                <div
                    style={{
                        ...
                        alignItems: 'center',
                        justifyContent: 'center',
                        borderRadius: '110px', // ~21% rounding (Standard iOS-style Squircle)
                    }}
                >
                    {/* Centered P-Icon Scaled to ~60% Height (300px) */}
                    <svg
                        width="300"
                        height="300"
