                ...
                <Section background="subtle">
                    <div className="mx-auto max-w-7xl px-4 grid md:grid-cols-2 gap-12 items-center">
                        <div className="order-2 md:order-1">
                            <Reveal delay={100}>
                                <p className="text-xs text-slate-500 uppercase tracking-wider font-medium mb-2">Example output</p>
                                <Card variant="tilt" glowColor="emerald">
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            {[
                                ...
                                <Reveal key={i} delay={i * 100} className="h-full">
                                    <Card variant="tilt" className="h-full" contentClassName="pt-12">
                                        <div className="absolute top-4 left-6 bg-slate-900 border border-slate-700 text-emerald-500 font-mono text-sm px-3 py-1 rounded-full z-10">
                                            {s.step}
                                        </div>
