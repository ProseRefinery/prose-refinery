        ...
        <>
                ...
                <GridGlowBackground>
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
                        <div className="max-w-3xl mx-auto">
                            <Reveal>
                                <HeroBadge icon="award">How It Works</HeroBadge>
                            </Reveal>
                            ...
                            <Reveal delay={200}>
                                <div className="space-y-6 text-lg text-slate-300 leading-relaxed">
                                    ...
                                    <p className="text-slate-400">
                                        We do not offer stylistic polish, motivational feedback, or generic writing advice. We diagnose and correct failures in plot architecture, character escalation, pacing pressure, and world-system logic. That prevents revision cycles from wasting months.
                                    </p>
                                </div>
                            </Reveal>
                        </div>
            ...
            <Section background="subtle">
                <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <Reveal delay={100}>
                        <Card variant="tilt" className="mb-12">
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <Reveal delay={100}>
                        <p className="text-lg text-slate-400 mb-8 max-w-xl mx-auto">
                            Start with our 3-minute diagnostic. We&apos;ll recommend the perfect editorial
