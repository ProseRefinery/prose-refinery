                    ...
                    <Reveal>
                        ...
                        <div className="prose prose-invert prose-emerald max-w-none space-y-12">
                            ...
                            <section>
                                ...
                                <ul className="list-disc pl-6 text-slate-400 space-y-2">
                                    <li><span className="text-emerald-400">Within 24 hours of purchase, and before work begins:</span> Full refund</li>
                                    <li><span className="text-emerald-400">After work begins:</span> Refunds are not available except under the Actionability Standard below</li>
                                </ul>
                                <div className="mt-6 p-4 bg-slate-800/50 rounded-lg border border-emerald-500/20">
                                    <h3 className="text-lg font-bold text-emerald-400 mb-2">Actionability Standard</h3>
                                    <p className="text-slate-300">
                                        If your report does not clearly identify actionable next steps, request clarification within 7 days of delivery. We will revise the report at no charge. If the revised report still does not meet this standard, you will receive a full refund.
                                    </p>
                                </div>
                            </section>
