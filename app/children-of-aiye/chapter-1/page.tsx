    ...
    <div className="min-h-screen" style={{ backgroundColor: '#0a0a0a' }}>
      ...
      <main className="max-w-2xl mx-auto px-6 py-16 md:py-24">
        ...
        <header className="mb-12 text-center">
          ...
          >
            The city breathes smoke and prayer.
          </p>
        </header>
        ...
        >
          ...
          {/* Scene Break */}
          <p className="text-center my-12 text-2xl tracking-widest" style={{ color: '#666666' }}>
            * * *
          </p>
          ...
          <p>
            <em>ANOMALY: CLASS UNKNOWN. UNREGISTERED LIGHT. PENALTY PENDING.</em>
          </p>
          ...
          <p>
            &quot;Ma beru, omo mi,&quot; she&apos;d whispered that night. <em>Don&apos;t be afraid, my child.</em> Then, pressed close enough he felt her heartbeat against his temple: &quot;The city will call you smoke. Teach it to remember fire.&quot; Her last words before the light took her.
          </p>
          ...
          <p>
            The metal groaned. He felt it through his soles, a vibration that said <em>not much longer</em>. But the opposite roof waited, close enough. He&apos;d make it.
          </p>
          ...
          <p>
            &quot;E ma binu, Olorun,&quot; someone sobbed from the street. <em>God, forgive us.</em>
          </p>
        ...
        <div className="mt-20 pt-12 border-t border-gray-800">
          <div className="text-center">
            ...
            <p
              ...
              style={{ color: '#888888' }}
            >
              Afolabi&apos;s story is just beginning. The gods are waking. The Ajogun are hungry.
            </p>
